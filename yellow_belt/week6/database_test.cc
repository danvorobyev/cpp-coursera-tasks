...
void TestDatabaseFind() {
    ...
    }
    {
        ...
        const vector<pair<Date, string>> expected = {{{2014, 11, 17}, "Monday"},
                                                     {{2016, 11, 17}, "Thursday"}};
...
void TestDatabaseLast() {
    {
        ...
        AssertEqual(db.Last({2017, 11, 17}), pair<Date, string>{{2017, 11, 17}, "One more event"},
                    "Database last: successful 1");
        AssertEqual(db.Last({2017, 11, 16}), pair<Date, string>{{2016, 11, 17}, "Thursday"},
                    "Database last: successful 2");
        AssertEqual(db.Last({2016, 11, 17}), pair<Date, string>{{2016, 11, 17}, "Thursday"},
                    "Database last: successful 3");
        AssertEqual(db.Last({2016, 11, 18}), pair<Date, string>{{2016, 11, 17}, "Thursday"},
                    "Database last: successful 4");
        AssertEqual(db.Last({2014, 11, 18}), pair<Date, string>{{2014, 11, 17}, "Monday"},
                    "Database last: successful 5");
        AssertEqual(db.Last({2014, 11, 17}), pair<Date, string>{{2014, 11, 17}, "Monday"},
    ...
    }
    {
        ...
        db.Add({2017, 11, 17}, "One more event");
        db.Add({2017, 11, 17}, "Friday");
        AssertEqual(db.Last({2017, 11, 17}), pair<Date, string>{{2017, 11, 17}, "Friday"},
    ...
    }
    {
        ...
        AssertEqual(db.Last({2017, 11, 17}), pair<Date, string>{{2016, 11, 17}, "Thursday"},
                    "Database last and remove 2");
    }
}
