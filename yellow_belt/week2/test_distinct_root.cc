...
void TestOneCoefficient() {
    AssertEqual(GetDistinctRealRootCount(0, 1, 0), 1);
    AssertEqual(GetDistinctRealRootCount(0, 1000000, 0), 1);
    AssertEqual(GetDistinctRealRootCount(0, -1000000, 0), 1);

    AssertEqual(GetDistinctRealRootCount(1, 0, 0), 1);
    AssertEqual(GetDistinctRealRootCount(-100000, 0, 0), 1);
    AssertEqual(GetDistinctRealRootCount(100000, 0, 0), 1);

    AssertEqual(GetDistinctRealRootCount(0, 0, 1000000), 0);
    AssertEqual(GetDistinctRealRootCount(0, 0, 1), 0);
    AssertEqual(GetDistinctRealRootCount(0, 0, -100000), 0);
}
...
void TestLinear() {
    AssertEqual(GetDistinctRealRootCount(0, 2, 5), 1);
    AssertEqual(GetDistinctRealRootCount(0, 2, -5), 1);
    AssertEqual(GetDistinctRealRootCount(0, -2, 5), 1);
    AssertEqual(GetDistinctRealRootCount(0, -2, -5), 1);
}
...
int main() {
  ...
  runner.RunTest(TestOneCoefficient, "TestOneCoefficient");
