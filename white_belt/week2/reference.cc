...
void change_capital() {
    ...
    if (country_capitals.find(country) == country_capitals.end()) {
...
void rename() {
    ...
    if (old_country_name == new_country_name 
        || country_capitals.find(old_country_name) == country_capitals.end() 
        || country_capitals.find(new_country_name) != country_capitals.end()) {
